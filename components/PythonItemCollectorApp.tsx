...
import { RESULT_FAIL, RESULT_PASS, smokeStatusLabel } from '@/lib/ui-labels';
      ...
      {checks.length > 0 && (
        <section className="panel panel--compact">
          <h2 className="panel__title">
            점검 결과{' '}
            {ok === true && <span className="badge">{RESULT_PASS}</span>}
            {ok === false && <span className="badge badge--warn">{RESULT_FAIL}</span>}
          </h2>
