...
검색필터 목록에서 지정한 **행 범위**의 검색필터 설정을 순차적으로 **삭제**합니다.
...
망고보드 **P3_필터단위_설정수정_검색필터설정삭제** 탭 — 사이트·목록URL·행범위 입력 →
[행 목록 확인] 또는 [삭제 시작]

## 중단

`.delete_stop` 플래그 (보드 [작업중단] 이 생성)

## ⚠️ 주의

**되돌릴 수 없는 삭제 작업입니다.** 실행 전 [행 목록 확인] 으로 대상을 반드시
확인하세요.
