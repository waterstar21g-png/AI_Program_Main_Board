...
**P2_Product_Capture_App**(Node/Playwright)과 **같은 작업**을 하는 파이썬 독립 배치입니다.
이 폴더만으로 완결됩니다. Next.js/npm 불필요.
...
1. Python 설치: https://www.python.org/downloads/ (`Add python.exe to PATH` 체크)
